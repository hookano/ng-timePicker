...
TimePicker.prototype.buildHTML = function() {
  ...
  var colonDiv1 = document.createElement("span"),
    colonDiv2 = document.createElement("span"),
    colonDiv3 = document.createElement("span");
  colonDiv1.innerHTML = ":";
  colonDiv2.innerHTML = ":";
  colonDiv3.innerHTML = ":";
...
TimePicker.prototype.refreshInputs = function() {
  ...
  var hours = this.value.hours < 10 ? "0" + this.value.hours : this.value.hours,
    minutes =
      this.value.minutes < 10 ? "0" + this.value.minutes : this.value.minutes,
    seconds =
      this.value.seconds < 10 ? "0" + this.value.seconds : this.value.seconds;
...
TimePicker.prototype.on = function() {
  var $this = angular.element(this.el);
